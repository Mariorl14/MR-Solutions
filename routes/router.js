...
router.get('/homeFavtel', authController.isAuthenticated,authController.authRol, NoCache.nocache,  async (req, res)=>{
...
/// client instance for auth
    ...
    res.render('homeFavtel', {rows:rows,user:user,layout: 'layoutFavtel'});
...
router.get('/layoutFavtel',  (req, res)=>{
    /*
    res.render('layout', {
        user: req.user,
      })
